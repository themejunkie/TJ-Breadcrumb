<?php
/**
 * Plugin Name:  TJ Breadcrumb
 * Plugin URI:   https://github.com/
 * Description:  This plugin will add the functionality to display a full chain of links to the current page. 
 * Version:      1.0
 * Author:       Theme Junkie
